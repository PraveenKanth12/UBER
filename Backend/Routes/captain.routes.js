...
routes.get('/profile',authMiddleware.authCaptain,captainController.getProfileCaptain);

routes.get('/logout',authMiddleware.authCaptain,captainController.logoutCapatain);
